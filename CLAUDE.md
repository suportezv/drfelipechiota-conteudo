...
- Drive (brutos): pasta **"Dr. Felipe Chiota - Brutos"**, id `1K2KbBds5POHZNZfJpLmdw_Y2FkBA-4F2` (criada 2026-08-20, dona: suporte@zavi.ag, link: https://drive.google.com/drive/folders/1K2KbBds5POHZNZfJpLmdw_Y2FkBA-4F2). **PENDENTE**: ativar "qualquer pessoa com o link: leitor" na pasta pela interface do Drive (o conector MCP só compartilha por e-mail); sem isso o download direto por curl não funciona e o fallback é o conector (limite ~4 MB por arquivo).
