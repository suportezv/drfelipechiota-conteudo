...
- **`scripts/`**: setup e validação do ambiente (Linux/cloud), wrapper do HyperFrames (`hf.sh`) e os scripts genéricos de produção (decupagem por âncora, LUT S-Log2, ZIP remoto, imagem por IA, upload para o Drive).
